...
func TestActiveScanners(t *testing.T) {
	...
	// 2. Test CSRF Scanner on /dashboard POST
	...
	// 3. Test Headers passive Scanner on /
	...
	expectedVulns := []string{"CORS Misconfiguration", "Security Misconfiguration", "Rate Limit Testing"}
