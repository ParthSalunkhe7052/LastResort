...
# 2. Start Go Core Backend in a separate window
...
# 3. Start Vite React UI in a separate window
...
Write-Host "`nAll three processes launched in separate terminal windows! Monitor logs and press CTRL+C inside the respective terminals to stop services." -ForegroundColor Yellow
